                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $row['order_no'] ?></td>
												<td><?php foreach (getData($cust) as $dat) {
													echo $dat['fname'];
												} ?></td>
                        <td>
                          <?php
                        ...
                        $sta=$row['status'];
												if($sta == 'inorder'){
													...
													$a='|<a href="od_up.php?q='.$row['order_no'].'&&typ=disp">Dispatch</a>';
												} else if($sta == 'Processed'){
													$a='';
												} else if($sta == 'Picked'){
													$a='';
												} else if($sta == 'In Transit'){
													$a='|<a href="od_up.php?q='.$row['order_no'].'&&typ=done">Complete</a>';
												} else if($sta == 'Delivered'){
													$a='';
												}
												 ?>
                        <td><a href="orderstat.php?q=<?php echo $row['order_no']; ?>">Track</a><?php echo $a; ?></td>
